...
tags:
  - Pédagogie
image:
  src: ../../assets/ghost-images/m-e-learning-child-learning-on-line-study-and-knowledge-illustration-with-copyspace.jpg
  alt: L’informatique en cycle 4 ?
---
...
*   divers domaines d’étude. Les données et questions afférentes sont disponibles et intéressantes dans nombre de domaines concrets – économie, sport, vie sociale, environnement, réseaux sociaux, etc. Il est important qu’à un moment du cours, les élèves choisissent eux-mêmes le domaine qu’ils entendent étudier. Un projet de fin de cycle pourrait être un exposé, retraçant toutes les étapes d’un travail sur un corpus précis (collecte, analyse, mise en graphique, etc.)
